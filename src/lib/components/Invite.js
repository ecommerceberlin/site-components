...
const Invite = ({ person={}, text="See you!", from=", ", color=undefined, template="teh20_visitor_template1" }) => {
  ...
  return (
    ...
    <Grid item md={7} sm={6} xs={12}>
      ...
      <img src={getInviteOgImage(`${text} ${_get(person, 'fname', '')} ${from} ${_get(person, 'cname2')}.`, template, color)} alt="" className={classes.image} />
      </Box>
    </Grid>
    </Grid>
    </div>
