...
const ScheduleVenueMinimized = ({ name, company, classes, total, template, selectedVenue, venueSelect, venueSelectReset}) => (
...
ScheduleVenueMinimized.defaultProps = {
  total : 4,
  template : "black"
}
...
export default enhance(ScheduleVenueMinimized);
